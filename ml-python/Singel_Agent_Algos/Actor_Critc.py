...
class ActorCritic(tf.keras.Model):
  ...
  def __init__(
    ...
    self.commn2 =layers.Dense(num_hidden_units, activation="relu")
    self.commn3=layers.Dense(num_hidden_units, activation="relu")
...
for i in range(max_episodes):
  ...
  if (i+1)%1000 ==0:
        plt.plot(np.arange(i+1),all_ep_reward , color='green')
        plt.xlabel('Episode')
        plt.ylabel('Reward')
